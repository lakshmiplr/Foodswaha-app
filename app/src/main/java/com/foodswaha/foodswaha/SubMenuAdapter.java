...
public class SubMenuAdapter extends ArrayAdapter<SubMenu> {
    private static final String TAG = "SubMenuAdapter";
    ...
    public SubMenuAdapter(Context context, int resource, List<SubMenu> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SubMenu cartSubMenuObject = cartInstance.getCartItem(subMenu.getId());
        if( cartSubMenuObject != null ){
            subMenu.setQuantity(cartSubMenuObject.getQuantity());
        }
        else{
